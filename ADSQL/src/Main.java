...
// Ejemplo de insertar varios registros
            ...
            String sqlSelect = "SELECT * FROM usuarios WHERE fecha_nacimiento < '1986-01-01'";
            ...
            while (rs.next()) {
                ...
                Usuario user = new Usuario(id,nombre,apellido,email,fechaNacimiento,ciudad,pais,saldo);
                usuarios.add(user);
