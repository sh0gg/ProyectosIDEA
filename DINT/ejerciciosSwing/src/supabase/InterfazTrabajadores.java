...
public class InterfazTrabajadores extends JFrame {
	...
	public InterfazTrabajadores() {
		...
		pIDTrabajador.setBorder(new TitledBorder(null, "Identificaci\u00F3n del trabajador", TitledBorder.LEADING,
		...
		pProfesion.add(lProfesiones, gbc_lProfesiones);		
		...
		lProfesiones.addListSelectionListener(new ListSelectionListener() {
		    public void valueChanged(ListSelectionEvent e) {
		        if (!e.getValueIsAdjusting()) {
		            if (lProfesiones.getSelectedIndex() != -1) {
		                bEliminarProfesion.setEnabled(true);
		            } else {
		                bEliminarProfesion.setEnabled(false);
		            }
		        }
