...
public class InterfazTrabajadores extends JFrame {
    ...
    private JButton bEliminarProfesion;
    ...
    public InterfazTrabajadores() {
    	setTitle("Interfaz de Trabajadores - David Besada Ramilo");
        ...
        gbl_pProfesion.rowHeights = new int[]{0, 0, 0};
        gbl_pProfesion.columnWeights = new double[]{1.0, 0.0, Double.MIN_VALUE};
        gbl_pProfesion.rowWeights = new double[]{1.0, 0.0, Double.MIN_VALUE};
        ...
        lProfesiones.addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                boolean haySeleccion = lProfesiones.getSelectedIndex() != -1;
                bEliminarProfesion.setEnabled(haySeleccion);
                actualizarEstadoBotonTrabajador();
            }
        });
        
                bEliminarProfesion = new JButton("Eliminar profesión");
                bEliminarProfesion.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (idx != -1) {
                            ...
                            bEliminarProfesion.setEnabled(false);
                            actualizarEstadoBotonTrabajador();
                        }
                    }
                });
