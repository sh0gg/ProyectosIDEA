    ...
    private class SwingAction_1 extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (mail.isEmpty() || contra.isEmpty() || contra2.isEmpty()) {
                DialogoLogin dialog = new DialogoLogin("Debes rellenar todos los campos.");
            ...
            try {
                ...
                if (signupResult.contains("access_token")) {
                    ...
                    String accessToken = extraerCampoJson(signupResult, "access_token");
                    if (accessToken != null && !accessToken.isEmpty()) {
                        InterfazTrabajadores frame = new InterfazTrabajadores();
                        frame.setSesion(mail, accessToken);
