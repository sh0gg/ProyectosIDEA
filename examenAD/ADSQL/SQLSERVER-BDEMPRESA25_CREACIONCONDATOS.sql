-- ######################################################################
-- 1. XESTI?N DA BASE DE DATOS (CREATE/DROP)
-- ######################################################################
...
-- Comproba se a base de datos existe e b?rraa (Usando a vista de cat?logo sys.databases)
IF EXISTS (SELECT name FROM sys.databases WHERE name = @dbName)
BEGIN
    -- Forzar a desconexi?n de todos os usuarios para permitir o borrado
    ALTER DATABASE EMPRESA25 SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE EMPRESA25;
    PRINT 'Base de datos BDEMPRESA25 borrada con ?xito.';
END
GO

-- Creaci?n da base de datos
...
-- ######################################################################
-- 2. XESTI?N DAS TABOAS (DROP IF EXISTS)
-- -- ######################################################################
...
-- ######################################################################
-- 3. CREACI?N DE TABOAS CON PK e UNIQUE
-- ######################################################################
...
-- T?BOA EMPREGADOFIXO (Subclase de EMPREGADO)
...
-- T?BOA EMPREGADOTEMPORAL (Subclase de EMPREGADO)
...
-- T?BOA LUGAR (Lugar do Departamento)
CREATE TABLE LUGAR (
...
-- ######################################################################
-- 4. DEFINICI?N DAS RESTRICCI?NS E CLAVES ALLEAS (FOREIGN KEYS e CHECK)
-- ######################################################################

-- RESTRICCI?NS DE EMPREGADO
...
-- ######################################################################
---
--- DESACTIVACI?N TEMPORAL DE RESTRICCI?NS
---

-- Desactiva a comprobaci?n de TODAS as restrici?ns (inclu?das FKs e CHECKs) para permitir a inserci?n
PRINT 'Desactivando restrici?ns para a inserci?n de datos...';
...
GO
-- INSERTS EMPREGADO 
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Pepe', 'L?pez', 'L?pez', '1111111', 'Olmo', 23, '4', '27003', 'Lugo', NULL, '1969-07-07', 'H', NULL, 1);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Jos? Manuel', 'Garc?a', 'Gra?a', '2525252', 'Illas Canarias', 101, '2-B', NULL, 'Vigo', NULL, '1966-09-02', 'H', '1111111', 2);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Agosti?o', 'Cervi?o', 'Seoane', '8888889', 'Montero R?os', 120, '4-D', '36208', 'Vigo', NULL, '1954-10-12', 'H', '1111111', 4);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Sara', 'Plaza', 'Mar?n', '4444444', 'Ciruela', 10, '6-B', '15705', 'Santiago', NULL, '1969-07-29', 'M', '1111111', 5);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Ana Mar?a', 'Ramilo', 'Barreiro', '7777777', 'Virxe da cerca', 23, NULL, NULL, 'Santiago', NULL, '1962-03-04', 'M', '1111111', 6);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Rocio', 'L?pez', 'Ferreiro', '0010010', 'Montero R?os', 145, '6-G', '36208', 'Vigo', NULL, '1975-05-21', 'M', '1010001', 1);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Germ?n', 'G?mez', 'Rodr?guez', '0999900', 'Sanjurjo Bad?a', 98, '3-D', '36212', 'Vigo', NULL, '1965-08-14', 'H', '8888889', 4);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Felix', 'Barreiro', 'Vali?a', '1100222', 'Rinlo', 5, NULL, '27709', 'Ribadeo', NULL, '1968-10-01', 'H', '7777777', 6);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Eligio', 'Rodrigo', NULL, '1231231', 'Espi?o', 3, '', '15708', 'Santiago', NULL, '1973-01-02', 'H', '4444444', 5);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Mari?a', 'Bello', 'Arias', '1341431', 'Gran V?a', 23, '4-D', NULL, 'Vigo', NULL, '1970-11-01', 'M', '2525252', 2);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Javier', 'Lamela', 'L?pez', '3330000', 'Avda de Vigo', 120, '4-C', NULL, 'Pontevedra', NULL, '1959-09-20', 'H', '2221111', 3);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Beatr?z', 'Mallo', 'L?pez', '6000006', 'Cardenal Quiroga', 10, '2-A', '27400', 'Monforte', NULL, '1965-03-10', 'M', '2221111', 3);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Paula', 'Mari?o', 'L?pez', '3338883', 'Pi?eira', 10, NULL, '27400', 'Monforte', NULL, '1969-01-01', 'M', '6000006', 3);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Rosa', 'Mari?o', 'Rivera', '4044443', 'Pi?eira', 25, NULL, '27400', 'Monforte', NULL, '1972-03-02', 'M', '6000006', 3);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Ux?o', 'Cabado', 'Penalta', '5000000', 'Nueva', 20, '3-C', NULL, 'Santiago', NULL, '1970-02-19', 'H', '2221111', 3);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Anxos', 'Loures', 'Freire', '5555000', 'Rosal?a de Castro', 105, '4-F', NULL, 'Santiago', NULL, '1982-12-16', 'M', '5000000', 3);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Alex', 'M?ndez', 'Garc?a', '7000007', 'Peregrina', 3, '1', NULL, 'Pontevedra', NULL, '1965-12-01', 'H', '3330000', 3);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Rub?n', 'Guerra', 'V?zquez', '8888877', 'Preguntoiro', 11, '1', NULL, 'Santiago', NULL, '1969-05-29', 'H', '7777777', 6);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Angeles', 'L?pez', 'Arias', '9876567', 'San Telmo', 5, '2-C', '36680', 'A Estrada', NULL, '1957-05-04', 'M', '4444444', 5);
...
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Celia', 'Bueno', 'Vali?a', '9990009', 'Montero R?os', 120, '4-D', '36208', 'Vigo', NULL, '1973-07-20', 'M', '1010001', 1);
INSERT INTO EMPREGADO (Nome, Apelido1, Apelido2, NSS, Rua, Numero_Calle, Piso, CP, Localidade, Provincia, DataNacemento, Sexo, NSSSupervisa, NumDepartamentoPertenece) VALUES ('Paulo', 'M?ximo', 'Guerra', '9998888', 'Montero R?os', 29, '2-A', NULL, 'Santiago', NULL, '1968-04-27', 'H', '7777777', 6);
GO

-- INSERTS DEPARTAMENTO ( os directores (NSSDirector) xa est?n en EMPREGADO)
...
INSERT INTO DEPARTAMENTO (NumDepartamento, NomeDepartamento, NSSDirector) VALUES (3, 'T?CNICO', '2221111');
INSERT INTO DEPARTAMENTO (NumDepartamento, NomeDepartamento, NSSDirector) VALUES (4, 'INFORM?TICA', '8888889');
INSERT INTO DEPARTAMENTO (NumDepartamento, NomeDepartamento, NSSDirector) VALUES (5, 'ESTAD?STICA', '4444444'); 
INSERT INTO DEPARTAMENTO (NumDepartamento, NomeDepartamento, NSSDirector) VALUES (6, 'INNOVACI?N', '7777777');
GO
...
INSERT INTO PROXECTO (NumProxecto, NomeProxecto, Lugar, NumDepartControla) VALUES (3, 'APLICACI?N CONTABLE', 'VIGO', 4);
INSERT INTO PROXECTO (NumProxecto, NomeProxecto, Lugar, NumDepartControla) VALUES (4, 'INFORME ESTADISTICO ANUAL', 'A ESTRADA', 5);
INSERT INTO PROXECTO (NumProxecto, NomeProxecto, Lugar, NumDepartControla) VALUES (5, 'PRODUCI?N NOVO PRODUTO', 'RIBADEO', 6);
INSERT INTO PROXECTO (NumProxecto, NomeProxecto, Lugar, NumDepartControla) VALUES (6, 'DESE?O NOVO CPD LUGO', 'LUGO', 3);
INSERT INTO PROXECTO (NumProxecto, NomeProxecto, Lugar, NumDepartControla) VALUES (7, 'MELLORAS SOCIAIS', 'VIGO', 1);
INSERT INTO PROXECTO (NumProxecto, NomeProxecto, Lugar, NumDepartControla) VALUES (8, 'DESE?O NOVA TENDA VIGO', 'MONFORTE', 3);
...
GO
---
---- ACTIVACI?N E VALIDACI?N DE RESTRICCI?NS
---

-- Reactiva e valida todas as restrici?ns. Se algunha regra foi violada durante a inserci?n, fallar? aqu?.
PRINT 'Activando e validando restrici?ns (FKs, CHECKs)...';
...
GO
PRINT 'Script completado. A base de datos BDEMPRESA25 est? lista.';