...
public class Fotografo implements Serializable {
    ...
    public Fotografo(boolean borrado,int codigo, String licencia, String nombre, String estudio, int numFotografias, List<Fotografia> fotografias) {
